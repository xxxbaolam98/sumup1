...
class CategoryAction extends \Magento\Ui\Component\Listing\Columns\Column
{
    /** Url path */
    const POST_URL_PATH_EDIT = 'sumup/category/edit';
    const POST_URL_PATH_DELETE = 'sumup/category/delete';
